...
function showInstructions(){
    app.loginScreen.open('#my-instructions-screen',false);
    setTimeout(function(){
        if(document.getElementById("animatie1").children[1]) {
            document.getElementById("animatie1").children[1].remove();
        }
        if(document.getElementById("animatie2").children[1]) {
            document.getElementById("animatie2").children[1].remove();
        }
        if(document.getElementById("animatie3").children[1]) {
            document.getElementById("animatie3").children[1].remove();
        }
        if(document.getElementById("animatie4").children[1]) {
            document.getElementById("animatie4").children[1].remove();
        }
        if(!swiper) {
...
function closeScreens(){
    ...
    app.loginScreen.close('#my-instructions-screen',true);
    swiper.slideTo(0,0);
}
...
document.addEventListener("deviceready", function() { 
    ...
    try{
        ...
        readfromwww('application/json', 'scaninstructions_1.json',
        data1 => {
            scan1=data1;
        ...
        readfromwww('application/json', 'scaninstructions_2.json',
        data2 => {
            scan2=data2;
            var animation = bodymovin.loadAnimation({
        ...
        readfromwww('application/json', 'scaninstructions_3.json',
        data3 => {
            scan3=data3;
            var animation = bodymovin.loadAnimation({
                container: document.getElementById('animatie3'),
                renderer: 'svg',
                loop: true,
                autoplay: true,
                animationData : scan3
        ...
        readfromwww('application/json', 'scaninstructions_4.json',
        data4 => {
            scan4=data4;
            var animation = bodymovin.loadAnimation({
                container: document.getElementById('animatie4'),
                renderer: 'svg',
                loop: true,
                autoplay: true,
                animationData : scan4
